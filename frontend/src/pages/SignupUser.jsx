  ...
  const singupUser = async (signupData) => {
    try {
      ...
      if (res.ok && data) {
        ...
        showAlert('error', 'Signup Failed', 'An error occurred during registration. Please try again.');
      }
    } catch (error) {
            ...
            <div className="w-full space-y-6 lg:pr-8 flex flex-col items-center lg:items-center lg:pl-16">
              <div className="space-y-4 text-center lg:text-center">
                ...
                <p className={`text-lg leading-relaxed transition-colors duration-300 ${
                  ...
                  Start your productivity journey today. Create your account and manage your tasks efficiently.
                </p>
              </div>
